...
;; Skroty klawiszowe dla wbudowanych opcji.

(global-set-key [f1] 'shell)
(global-set-key [C-tab] 'other-window) 	;; Nie zawsze dziala.
;; Skrot klawiszowy z innego trybu moze go przykryc.


;; Ustawienie wbudowanych trybow.

(column-number-mode t) ;; Wlaczenie trybu podające numer kolumny.
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (multiple-cursors rust-playground cargo rust-mode beacon auctex-latexmk auctex avy use-package undo-tree swiper-helm slime rainbow-delimiters impatient-mode helm-gtags ggtags function-args auto-complete auto-compile aggressive-indent achievements)))
...
(use-package slime
  ...
  (setq inferior-lisp-program "sbcl") ;; Ustawienie Steel Bank Common Lisp
