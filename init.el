...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (yasnippet-snippets ox-reveal htmlize jedi elpy yasnippet flycheck zenburn-theme which-key use-package undo-tree try swiper-helm rust-playground rust-mode rainbow-delimiters org-bullets lorem-ipsum latex-pretty-symbols helm-gtags function-args counsel color-theme-modern color-theme beacon badwolf-theme badger-theme auto-complete auctex-latexmk aggressive-indent achievements ace-window))))
(custom-set-faces
